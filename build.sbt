...
/* entry point */
mainClass in (Compile, packageBin) := Some("com.example.myproj.Mongo")

mainClass in (Compile, run) := Some("com.example.myproj.Mongo")
...
/* assembly plugin */
mainClass in AssemblyKeys.assembly := Some("com.example.myproj.Mongo")
